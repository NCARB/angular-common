(function(angular) {
    ...
    <div class="flex-item" feedback>\
        <input name="streetLine1" ng-required="!hidden && !streetOptional" type="text" ng-attr-placeholder="{{streetLine1Placeholder}}" ng-model="address.streetLine1"/>\
    </div>\
    <div class="flex-item">\
    ...
    <div class="flex-item flex-fill flex-1of4" feedback>\
        ...
        function link(scope, elem, attrs, form) {
            ...
            scope.streetLine2Placeholder = angular.isDefined(attrs.streetLine2Placeholder)
                ...
                ? "Street Line 1"
                : "Street Line 2";
            scope.streetOptional = angular.isDefined(attrs.streetOptional)
                ? attrs.streetOptional
                : editAddressConfig.streetOptional
